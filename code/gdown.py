...
def get_url_from_gdrive_confirmation(contents):
    ...
    raise Exception("Could not retrieve the public link for the file. You may need to change its permissions to 'Anyone with the link' or there may already be excessive access permissions.")
